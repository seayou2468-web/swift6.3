...
echo "[1/5] extracting swift frontend pipeline"
./Scripts/extract_swift_pipeline.sh

echo "[2/5] building LLVM/Clang xcframework artifacts"
...
echo "[3/5] building MiniSwiftCompilerCore products"
...
echo "[4/5] building demo app target with production artifacts available"
...
echo "[5/5] staging demo-app build inputs"
